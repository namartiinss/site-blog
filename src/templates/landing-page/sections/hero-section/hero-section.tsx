...
export const HeroSection = () => {
  return (
    <section className="container max-w-7xl sm:px-6 lg:px-8 relative flex items-center justify-center mt-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[20rem] md:h-[36rem] items-center">
        <div className="flex flex-col items-center justify-center gap-4 md-items-start lg:items-start">
          ...
          <div className="flex flex-col justify-center gap-4 ">
            ...
            <div className="text-white flex flex-col gap-2 mt-5 md:items-start lg:items-start">
        ...
        <div className="relative h-[20rem] hidden md:h-full order-firts md:order-last items-center justify-center md:flex lg:flex">
          <Image
