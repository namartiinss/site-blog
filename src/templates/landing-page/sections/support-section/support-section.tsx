...
export const SupportSection = () => {
  return (
    <section className=" relative w-full m-0-auto flex justify-center pb-8 md:py-10 bg-gradient-to-r from-gray-500 to-gray-700">
      ...
      <div className="container flex flex-col items-center gap-12 relative">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-300 mb-16px">
          ...
          <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-cyan-200 mb-16px">
